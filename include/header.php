<?php
$path = 'http://localhost/final_project/layout/image/';
?>
<!DOCTYPE html>
...
<head>
    ...
    <!--=== All Plugins CSS ===-->
    <link href="./layout/assets/css/plugins.css" rel="stylesheet">
    <!--=== All Vendor CSS ===-->
    <link href="./layout/assets/css/vendor.css" rel="stylesheet">
    <!--=== Main Style CSS ===-->
    <link href="./layout/assets/css/style.css" rel="stylesheet">
    <!-- Modernizer JS -->
    <script src="./layout/assets/js/modernizr-2.8.3.min.js"></script>
                        ...
                        <div class="col-lg-6 text-right">
                            <div class="header-top-settings">
                                <ul class="nav align-items-center justify-content-end">
                                    ...
                                    <li class="language">
                                        <img src="./layout/assets/img/icon/en.png" alt="flag"> English
                                        <i class="fa fa-angle-down"></i>
                                        <ul class="dropdown-list">
                                            <li><a href="#"><img src="./layout/assets/img/icon/en.png" alt="flag"> english</a></li>
                                            <li><a href="#"><img src="./layout/assets/img/icon/fr.png" alt="flag"> french</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="minicart-item-wrapper">
                        <ul>
                            <li class="minicart-item">
                                <div class="minicart-thumb">
                                    <a href="product-details.html">
                                        <img src="./layout/assets/img/cart/cart-1.jpg" alt="product">
                                    </a>
                                </div>
                            ...
                            <li class="minicart-item">
                                <div class="minicart-thumb">
                                    <a href="product-details.html">
                                        <img src="./layout/assets/img/cart/cart-2.jpg" alt="product">
                                    </a>
                                </div>
                                <div class="minicart-content">
                                    <h3 class="product-name">
